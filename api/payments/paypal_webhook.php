    ...
    try {
        ...
        if ($result['success']) {
            ...
            if ($licenseResult['success']) {
                logError("Licencias generadas para orden {$order['order_number']} - Total: " . count($licenseResult['licenses']), 'licenses.log');
            } else {
                logError("Error generando licencias para orden {$order['order_number']}: " . $licenseResult['message'], 'licenses.log');
            }
