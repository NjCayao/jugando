        ...
        <div class="row">
                ...
                <div class="sidebar-card-compact">
                    <div class="sidebar-header-compact">
                        <div class="d-flex justify-content-between align-items-center">
                            ...
                            <a href="<?php echo SITE_URL; ?>/productos" class="btn btn-outline-danger btn-sm">
                    ...
                    <div class="sidebar-body-compact">
                        <form method="GET" id="filterForm">
                            <!-- Búsqueda -->
                            <div class="mb-4">
                                <h6 class="footer-title">Buscar</h6>
                            ...
                            <!-- Rango de Precio -->
                            <div class="mb-4">
                                <h6 class="footer-title">Precio</h6>
                                ...
                                <div class="d-flex flex-wrap gap-1">
                                    <small class="text-muted w-100 mb-2">Rangos populares:</small>
                                    <button type="button" class="btn btn-outline-secondary btn-sm" onclick="setPriceRange(0, 10)">$0-$10</button>
                                    <button type="button" class="btn btn-outline-secondary btn-sm" onclick="setPriceRange(10, 50)">$10-$50</button>
                                    <button type="button" class="btn btn-outline-secondary btn-sm" onclick="setPriceRange(50, 100)">$50-$100</button>
                                </div>
                            </div>
            ...
            <div class="col-lg-9">
                ...
                <div class="dashboard-section mb-4">
                    <div class="section-header-compact">
                        <div class="row align-items-center">
                            <div class="col-md-6">
                                <h4 class="section-title-compact mb-1"><?php echo htmlspecialchars($pageTitle); ?></h4>
                ...
                <?php if (empty($products)): ?>
                    <div class="empty-state-compact text-center py-5">
                        <div class="empty-icon-compact mx-auto mb-4">
                                ...
                                <div class="product-card h-100">
                                    <div class="product-image">
                                        ...
                                        <?php if ($product['is_featured']): ?>
                                            <span class="badge bg-warning position-absolute" style="top: 15px; right: 15px; z-index: 2;">DESTACADO</span>
                                        <?php endif; ?>
                                    </div>
                                    <div class="product-info">
                                        ...
                                        <div class="mb-3">
                                            <small class="text-muted">
                                                <i class="fas fa-code-branch me-1"></i> <?php echo $product['version_count']; ?> versiones
                                                <span class="ms-2">
                                                    <i class="fas fa-download me-1"></i> <?php echo number_format($product['download_count']); ?>
                                                </span>
                                            </small>
                                        </div>
